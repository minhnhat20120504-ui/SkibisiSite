...
function setupToggle(toggleButtonId, toggleListId) {
    ...
    // Láº¥y táº¥t cáº£ cĂ¡c menu
    const allToggles = document.querySelectorAll('.menu-edit-link-preview');

    toggleButton.addEventListener("click", function (event) {
        event.stopPropagation();

        // ÄĂ³ng táº¥t cáº£ cĂ¡c danh sĂ¡ch trá»« danh sĂ¡ch hiá»‡n táº¡i
        ...
        // Má»Ÿ hoáº·c Ä‘Ă³ng danh sĂ¡ch hiá»‡n táº¡i
    ...
    // ÄĂ³ng táº¥t cáº£ náº¿u nháº¥n ra ngoĂ i
...
function getDomain(inputUrl) {
    // ThĂªm http:// náº¿u ngÆ°á»i dĂ¹ng chá»‰ nháº­p tĂªn miá»n
    if (!inputUrl.startsWith('http://') && !inputUrl.startsWith('https://')) {
        inputUrl = 'http://' + inputUrl; // ThĂªm giao thá»©c máº·c Ä‘á»‹nh
    }
